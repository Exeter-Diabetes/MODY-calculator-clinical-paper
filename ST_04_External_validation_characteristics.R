...
write_xlsx(externalval_t1d_character_table,"ST_04_EARLY_INSULIN_TREATED_table.xlsx")
...
write_xlsx(externalval_t2d_character_table,"ST_04_NOT_EARLY_INSULIN_TREATED_table.xlsx")
