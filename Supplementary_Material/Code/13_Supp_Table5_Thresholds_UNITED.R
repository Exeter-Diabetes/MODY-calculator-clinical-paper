...
#This code produces Supplementary Table 5 
...
thresholds_UNITED <- calculate_thresholds_diagnostics(UNITED_joint$M, 
                                                      UNITED_joint$prob)
...
UNITED_THRESHOLDS_Supp_Table5 <- rbind(UNITED_5PERC,
                                       UNITED_10PERC,
                                       UNITED_15PERC,
                                       UNITED_20PERC, 
                                       UNITED_25PERC,
                                       UNITED_30PERC)
write_xlsx(UNITED_THRESHOLDS_Supp_Table5,"Supp_Table5.xlsx")
