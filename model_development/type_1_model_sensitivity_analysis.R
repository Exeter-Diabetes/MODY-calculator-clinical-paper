...
#   using only GAD antibody information
#
#:--------------------------------------------------------
...
united <- create_data(dataset = "united t1d", biomarkers = "full") %>%
...
saveRDS(run, "model_development/type_1_model_posteriors_sensivity_analysis.rds")
